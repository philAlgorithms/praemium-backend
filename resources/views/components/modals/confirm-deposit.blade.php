	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control edit-deposit-name" value="{{ $deposit->client->name }}" disabled aria-describedby="addon1">
		    </div>
		</div>
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" id="amount" value="{{ $deposit->amount }}" placeholder="Amount deposited" aria-label="Plan cost" aria-describedby="addon2">
		    </div>
		</div>
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" id="charge" value="{{ $deposit->charge }}" placeholder="Maximum cost" aria-label="charge" disabled aria-describedby="addon5">
		    </div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="input-group">
			<span class="input-group-text" id="addon3"><i class="cf cf-{{ $deposit->benefactorWallet->coin->code }}"></i></span>
		...
		<div class="form-group">
		    ...
		    <div class="input-group">
			<span class="input-group-text" id="addon3"><i class="cf cf-{{ $deposit->benefactorWallet->coin->code }}"></i></span>
			<input type="text" class="form-control" id="receiver" value="{{ $deposit->benefactorWallet->wallet_address }}" disabled  aria-describedby="addon3">
		    </div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="input-group">
			<span class="input-group-text" id="addon9"><i class="cf cf-{{ $deposit->benefactorWallet->coin->code }}"></i></span>
		...
		<input type="hidden" id="uuid" value="{{ $deposit->uuid }}">
		<div class="form-group">
