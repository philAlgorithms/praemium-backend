<x-modals.layout :id="$plan->name.'plan'" class="col-md-12 withdraw-modal">
    <div class="card card-plain text-start">
        <div class="card-header pb-0 text-left">
            <h3 class="font-weight-bolder text-info text-gradient">withdraw to package</h3>
	    <p class="mb-0">You are about to withdraw from {{ $plan->name }} package. <b>{{ dollar($plan->cost) }}</b> will be deducted from your funded account.</p>
	...
	<div class="card-body">
		...
		<div class="text-center">
			...
			<button class="btn bg-gradient-dark ms-auto mb-0 withdraw-btn" type="button" title="Next">Proceed</button>
			<button class="btn bg-gradient-dark ms-auto mb-0 d-none loading-withdraw-btn" type="button" disabled>
