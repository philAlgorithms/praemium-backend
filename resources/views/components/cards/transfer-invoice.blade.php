    ...
    <form class="" action="index.html">
		...
		<div class="row justify-content-between">
                    ...
                    <div class="col-lg-3 col-md-7 text-md-end text-start mt-5">
                    	<h6 class="d-block mt-2 mb-0">User: {{ $transfer->sender->name }}</h6>
                    	<p class="text-secondary">{{ $transfer->sender->email }}<br>
                      	    {{ $transfer->sender->country->nicename ?? 'N/A' }}
                    	</p>
                    </div>
                </div>
                <br>
		<div class="row justify-content-md-between">
    	    ...
    	    <div class="card-body">
                    ...
                    <div class="col-12">
                    	<div class="table-responsive">
                        	...
                        	<thead class="bg-default">
                          	    <tr>
                            		<th scope="col" class="pe-2 text-start ps-2">Receiver</th>
				...
				<tbody>
                          	    <tr>
                            	    	<td class="text-start">{{ $transfer->receiver->name }}</td>
                            	    	<td class="ps-4"></td>
