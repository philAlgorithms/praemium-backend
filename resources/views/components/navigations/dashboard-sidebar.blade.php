<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-heigh-vh-100 h-auto h-100" id="sidenav-collapse-main">
	    ...
	    <li class="nav-item">
        	<a data-bs-toggle="collapse" class="nav-link" href="#earnings" aria-controls="earnings" role="button" aria-expanded="false">
	    	    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
			<x-svg.document />
	    	    </div>
	    ...
	    <li class="nav-item">
		    ...
		    <ul class="nav ms-4 ps-3 nav-sm flex-column">
                    	<li class="nav-item">
                      	    <a class="nav-link " href="/finance-overview">
                        	<span class="sidenav-mini-icon text-xs"> F </span>
                        	<span class="sidenav-normal"> Finance overview </span>
                	    </a>
                    	</li>
                    </ul>
                </div>
