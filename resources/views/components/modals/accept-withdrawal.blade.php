	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control edit-withdrawal-name" value="{{ $withdrawal->client->name }}" disabled aria-describedby="addon1">
		    </div>
		</div>
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" id="amount" value="{{ $withdrawal->amount }}" placeholder="Amount withdrawan" aria-label="Plan cost" aria-describedby="addon2">
		    </div>
		</div>
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" id="charge" value="{{ $withdrawal->charge }}" placeholder="Maximum cost" aria-label="charge" disabled aria-describedby="addon5">
		    </div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="input-group">
			<span class="input-group-text" id="addon9"><i class="cf cf-{{ $withdrawal->benefactorWallet->coin->code }}"></i></span>
		...
		<input type="hidden" id="uuid" value="{{ $withdrawal->uuid }}">
		<div class="form-group">
